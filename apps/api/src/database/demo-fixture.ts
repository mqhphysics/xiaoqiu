...
const hometowns = ['武汉', '宜昌', '襄阳', '荆州', '黄冈', '长沙', '南昌', '合肥', '郑州', '杭州', '广州', '成都']
...
export const DEMO_PLAYERS: DemoPlayerDefinition[] = DEMO_TEAMS.flatMap((team, teamIndex) =>
  Array.from({ length: 14 }, (_, playerIndex) => {
    ...
    return {
      ...
      secondaryPosition,
      dominantFoot:
        playerIndex % 7 === 0 ? DominantFoot.BOTH : playerIndex % 3 === 0 ? DominantFoot.LEFT : DominantFoot.RIGHT,
      heightCm: 168 + ((teamIndex * 5 + playerIndex * 3) % 20),
      academicYear: `${2022 + ((teamIndex + playerIndex) % 4)}级`,
      major: team.major,
...
export const DEMO_MATCHES: DemoMatchDefinition[] = [
  match('GC26-A-R1-01', 'A组第1轮', '2026', 'GROUP', 'A', 1, 0, 1, MatchStatus.FINISHED, '2026-08-24T10:00:00+08:00', 2, 1, '物院德比节奏紧凑，一队凭借下半场反击锁定胜局。', 326),
  match('GC26-A-R1-02', 'A组第1轮', '2026', 'GROUP', 'A', 1, 2, 3, MatchStatus.FINISHED, '2026-08-24T16:00:00+08:00', 1, 1, '星火与雷霆各自掌控半场，最终握手言和。', 284),
  match('GC26-B-R1-01', 'B组第1轮', '2026', 'GROUP', 'B', 1, 4, 5, MatchStatus.FINISHED, '2026-08-25T10:00:00+08:00', 1, 0, '原子利用一次定位球取得开门红。', 241),
  match('GC26-B-R1-02', 'B组第1轮', '2026', 'GROUP', 'B', 1, 6, 7, MatchStatus.FINISHED, '2026-08-25T16:00:00+08:00', 2, 3, '教育联队在终场前完成逆转，打出首轮进球最多的比赛。', 309),
  match('GC26-A-R2-01', 'A组第2轮', '2026', 'GROUP', 'A', 2, 0, 2, MatchStatus.FINISHED, '2026-08-28T16:00:00+08:00', 3, 0, '一队通过持续前压取得三球胜利。', 338),
  match('GC26-A-R2-02', 'A组第2轮', '2026', 'GROUP', 'A', 2, 1, 3, MatchStatus.FINISHED, '2026-08-28T19:00:00+08:00', 2, 2, '双方四次改写比分，雷霆终场前扳平。', 351),
  match('GC26-B-R2-01', 'B组第2轮', '2026', 'GROUP', 'B', 2, 4, 6, MatchStatus.FINISHED, '2026-08-29T16:00:00+08:00', 2, 2, '山岳依靠高效反击从两球落后中追平。', 276),
  match('GC26-B-R2-02', 'B组第2轮', '2026', 'GROUP', 'B', 2, 5, 7, MatchStatus.LIVE, '2026-09-01T19:00:00+08:00', 1, 1, '比赛进入下半场，双方仍在争夺中场主动权。', 412),
  match('GC26-A-R3-01', 'A组第3轮', '2026', 'GROUP', 'A', 3, 0, 3, MatchStatus.SCHEDULED, '2026-09-04T16:00:00+08:00'),
  match('GC26-A-R3-02', 'A组第3轮', '2026', 'GROUP', 'A', 3, 1, 2, MatchStatus.SCHEDULED, '2026-09-04T19:00:00+08:00'),
  match('GC26-B-R3-01', 'B组第3轮', '2026', 'GROUP', 'B', 3, 4, 7, MatchStatus.POSTPONED, '2026-09-05T16:00:00+08:00', undefined, undefined, undefined, undefined, undefined, undefined, '受场地维护影响，顺延至 9 月 7 日。'),
  match('GC26-B-R3-02', 'B组第3轮', '2026', 'GROUP', 'B', 3, 5, 6, MatchStatus.SCHEDULED, '2026-09-05T19:00:00+08:00'),
  match('GC26-SF-01', '半决赛 1', '2026', 'KNOCKOUT', undefined, 1, undefined, undefined, MatchStatus.SCHEDULED, '2026-09-10T16:00:00+08:00'),
  match('GC26-SF-02', '半决赛 2', '2026', 'KNOCKOUT', undefined, 1, undefined, undefined, MatchStatus.SCHEDULED, '2026-09-10T19:00:00+08:00'),
  match('GC26-THIRD', '三四名决赛', '2026', 'KNOCKOUT', undefined, 2, undefined, undefined, MatchStatus.SCHEDULED, '2026-09-14T16:00:00+08:00'),
  match('GC26-FINAL', '绿茵杯决赛', '2026', 'KNOCKOUT', undefined, 2, undefined, undefined, MatchStatus.SCHEDULED, '2026-09-14T19:00:00+08:00'),

  match('GC25-QF-01', '2025 八强赛 1', '2025', 'KNOCKOUT', undefined, 1, 0, 7, MatchStatus.FINISHED, '2025-05-10T14:00:00+08:00', 2, 0, '物院一队稳健晋级四强。', 255),
  match('GC25-QF-02', '2025 八强赛 2', '2025', 'KNOCKOUT', undefined, 1, 2, 5, MatchStatus.FINISHED, '2025-05-10T16:00:00+08:00', 1, 2, '青藤在下半场完成逆转。', 231),
  match('GC25-QF-03', '2025 八强赛 3', '2025', 'KNOCKOUT', undefined, 1, 3, 6, MatchStatus.FINISHED, '2025-05-11T14:00:00+08:00', 3, 1, '雷霆用快速进攻建立优势。', 288),
  match('GC25-QF-04', '2025 八强赛 4', '2025', 'KNOCKOUT', undefined, 1, 4, 1, MatchStatus.FINISHED, '2025-05-11T16:00:00+08:00', 1, 1, '点球大战后物院二队晋级。', 302, 3, 4),
  match('GC25-SF-01', '2025 半决赛 1', '2025', 'KNOCKOUT', undefined, 2, 0, 5, MatchStatus.FINISHED, '2025-05-17T15:00:00+08:00', 2, 1, '一队在加速阶段连续创造机会。', 347),
  match('GC25-SF-02', '2025 半决赛 2', '2025', 'KNOCKOUT', undefined, 2, 3, 1, MatchStatus.FINISHED, '2025-05-17T18:00:00+08:00', 1, 2, '二队防守反击奏效，首次进入决赛。', 366),
  match('GC25-THIRD', '2025 三四名决赛', '2025', 'KNOCKOUT', undefined, 3, 5, 3, MatchStatus.FINISHED, '2025-05-24T15:00:00+08:00', 2, 3, '雷霆获得季军。', 381),
  match('GC25-FINAL', '2025 绿茵杯决赛', '2025', 'KNOCKOUT', undefined, 3, 0, 1, MatchStatus.FINISHED, '2025-05-24T19:00:00+08:00', 2, 2, '物院一队通过点球大战夺得冠军。', 618, 5, 4),
]
...
export const DEMO_ACCOUNTS: DemoAccountDefinition[] = [
  ...
  {
    username: 'player',
    displayName: DEMO_PLAYERS[10]!.displayName,
  ...
  {
    username: 'captain',
    displayName: DEMO_PLAYERS[6]!.displayName,
    verificationLevel: VerificationLevel.PLAYER_CONFIRMED,
    linkedTeamIndex: 0,
    linkedPlayerIndex: 6,
...
function secondaryPositionFor(position: PlayerPosition, index: number): PlayerPosition {
  ...
  if (position === PlayerPosition.DEFENDER) return index % 2 === 0 ? PlayerPosition.MIDFIELDER : PlayerPosition.DEFENDER
  if (position === PlayerPosition.MIDFIELDER) return index % 2 === 0 ? PlayerPosition.FORWARD : PlayerPosition.DEFENDER
